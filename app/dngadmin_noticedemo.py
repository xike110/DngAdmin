...
def noticedemo(request):
	...
	return render(request,"dngadmin/noticedemo.html",{
...
def noticedemo_post(request):
	...
	if '|' + str(dngroute_uid) + '|' in group.see_text:  # 判断查看权限
		...
		response = HttpResponseRedirect('/dngadmin/noticedemo/?jinggao=' + urlstr)
		return response

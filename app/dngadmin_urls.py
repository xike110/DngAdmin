...
from . import dngadmin_crud   #一键CRUD
...
urlpatterns = [   #路由映射
	...
	url(r'^crud/', dngadmin_crud.crud),  # 一键crud
	url(r'^crud_post/', dngadmin_crud.crud_post),  # 一键crud的post
	...
	url(r'^mail/', dngadmin_mail.mail),  # 邮件
	url(r'^mail_json/', dngadmin_mail.mail_json),  # 邮件json
	url(r'^mail_added/', dngadmin_mail.mail_added),  # 邮件新增
	url(r'^mail_delete/', dngadmin_mail.mail_delete),  # 邮件删除
	url(r'^mail_update/', dngadmin_mail.mail_update),  # 邮件更新修改
	url(r'^mail_search/', dngadmin_mail.mail_search),  # 邮件搜索
	...
	url(r'^ip/', dngadmin_ip.ip), #内置IP接口
	url(r'^ip_json', dngadmin_ip.ip_json), #内置IP接口
	url(r'^ip_post', dngadmin_ip.ip_post),  # 内置IP接口

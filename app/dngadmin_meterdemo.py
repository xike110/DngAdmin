...
def meterdemo(request):
	...
	return render(request,"dngadmin/meterdemo.html",{
...
def meterdemo_post(request):
	...
	if '|' + str(dngroute_uid) + '|' in group.see_text:  # 判断查看权限
		...
		response = HttpResponseRedirect('/dngadmin/meterdemo/?jinggao=' + urlstr)
		return response
